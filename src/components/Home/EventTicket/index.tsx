            ...
            <section className="dark:bg-darkmode pt-0">
                <div className="container">
                    <div className="text-center md:pb-20 pb-8">
                        <h2 className="pb-8" data-aos="fade-up" data-aos-delay="200" data-aos-duration="1000">El evento digital más esperado del año</h2>
                        <p data-aos="fade-up" data-aos-delay="300" data-aos-duration="1000" className="text-SlateBlueText dark:text-opacity-80 text-lg font-normal max-w-920 m-auto">
                            Únete a una experiencia donde las ideas se transforman en proyectos reales. 
                            Aprende de expertos, colabora con otros participantes y lleva tus habilidades 
                            al siguiente nivel en este hackathon de inteligencia artificial.
                        </p>
                    </div>
